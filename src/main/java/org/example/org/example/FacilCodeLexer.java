...
public class FacilCodeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "IDENTIFICADOR", "DIGITO", "IF", "ELSE", "RETURN", 
			"TRUE", "FALSE", "ADD", "SUB", "MUL", "DIV", "EQ", "NEQ", "LT", "GT", 
			"LEQ", "GEQ", "AND", "OR", "WS", "COMMENT", "ERROR"
		};
	}
	...
	public FacilCodeLexer(CharStream input) {
		super(input);
